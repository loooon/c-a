...
{
    public static String[] TOP_DOMAIN = new String[]{".gov.mo", ".com.tw", ".com.mo", ".co.cc", ".ce.ms", ".osa.pl",
            ".c.la", ".com.hk", ".net.in", ".edu.tw", ".org.tw", ".bij.pl", ".ac.cn", ".ah.cn", ".bj.cn", ".com.cn",
            ".cq.cn", ".fj.cn", ".gd.cn", ".gov.cn", ".gs.cn", ".gx.cn", ".gz.cn", ".ha.cn", ".hb.cn", ".he.cn",
            ".hi.cn", ".hk.cn", ".hl.cn", ".hn.cn", ".jl.cn", ".js.cn", ".jx.cn", ".ln.cn", ".mo.cn", ".net.cn",
            ".nm.cn", ".nx.cn", ".org.cn", ".qh.cn", ".sc.cn", ".sd.cn", ".sh.cn", ".sn.cn", ".sx.cn", ".tj.cn",
            ".tw.cn", ".xj.cn", ".xz.cn", ".yn.cn", ".zj.cn", ".nl.ae", ".org.uk", ".org.nz", ".org.bz", ".org.au",
            ".com.nu", ".com.my", ".com.au", ".co.uk", ".co.kr", ".co.jp", ".nu.ae", ".nl.ae", ".com.au", ".cf.gs",
            ".com.cn", ".net.cn", ".org.cn", ".edu.cn", ".com", ".cn", ".mobi", ".tel", ".asia", ".net", ".org",
            ".name", ".me", ".info", ".cc", ".hk", ".biz", ".tv", ".la", ".fm", ".cm", ".am", ".sh", ".us", ".in",
            ".ro", ".ru", ".hu", ".tk", ".co", ".cx", ".at", ".tw", ".ws", ".vg", ".vc", ".uz", ".to", ".tl", ".th",
            ".tf", ".tc", ".st", ".so", ".sk", ".sg", ".sc", ".pl", ".pe", ".nu", ".nf", ".ne", ".my", ".mu", ".ms",
            ".mo", ".lv", ".lt", ".lc", ".jp", ".it", ".io", ".im", ".ie", ".gs", ".gp", ".gl", ".gg", ".gd", ".fr",
            ".fi", ".eu", ".edu", ".dk", ".de", ".cz", ".ch", ".ca", ".bi", ".be", ".au", ".ae", ".pw", ".ly", ".wang",
            ".ren", ".top", ".club"};
     ...
     *
     * @param url
     *            例如：http://www.baidu.com/, http://a.baidu.com,
     *            http://www.abc.com:8080, http://www.xyz.com/abc/123.html
     ...
     *
     * @param url
     *            例如 http://abc.xyz.com, http://www.xyz.com:8080/index.html,
     *            http://a.b.c.xyz.com/
     * @return xyz.com
     * @see <参见的内容>
     */
        ...
        if (url != null)
        {
            for (int i = 0; i < url.length(); i++)
            {
                ...
                if (StringValidator.isLetter(c) // 英文
                        ...
                        || ":".equals(c) || ".".equals(c) || "-".equals(c) || "_".equals(c)
                        || "/".equals(c)
    ...
    public static void main(String[] args) throws Exception
    {
        try
        {
             ...
             * System.out.println(WebsiteUtil.exactPrimaryDomain(url)); url =
             * "http://www.zx110.org";
             * System.out.println(WebsiteUtil.exactDomain(url));
             * System.out.println(WebsiteUtil.exactPrimaryDomain(url)); url =
             * "http://abc.zx110.org/";
             * System.out.println(WebsiteUtil.exactDomain(url));
             * System.out.println(WebsiteUtil.exactPrimaryDomain(url)); url =
             * "http://abc.zx110.org/abc/index.html";
             * System.out.println(WebsiteUtil.exactDomain(url));
             * System.out.println(WebsiteUtil.exactPrimaryDomain(url)); String
             * domain ="zx110.org";
             * System.out.println(WebsiteUtil.resolveAddress(domain)); domain
             * ="ewtetretrewtrewtretre.com";
             ...
             * long t2 = System.currentTimeMillis(); System.out.println(t2-t1);
             * System.out.println(WebsiteUtil.isConnect("lyshcn.com")); long t3
             * = System.currentTimeMillis(); System.out.println(t3-t2);
             */
        }
        catch (Exception e)
        {
