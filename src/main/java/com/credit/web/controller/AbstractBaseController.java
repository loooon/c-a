...
public abstract class AbstractBaseController extends AbstractController
{
    ...
    public void refreshUserSession(Admin admin)
    {
        ...
        user.setRoleName(admin.getRole());
        user.setSuperAdmin(admin.getSuperAdmin());
        user.setCreateTime(TimeUtil.format(admin.getCreateTime(), TimeUtil.FORMAT_DATE_ONLY_ZH));
        XUserSessionManager.getCurrent().setXUser(user);
    }

    public void clearUserSession()
    {
        XUserSessionManager.getCurrent().getXUser().setIsSignedIn(false);
    }

	public XUserSession getUserSession()
	{
