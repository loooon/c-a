    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">${empty resource ?"新增":"更新"}服务</li>
            </ol>
        </section>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">${empty resource ?"新增":"更新"}服务</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
               ...
               $.ajax({
                   ...
                   success : function(result) {
                       ...
                       if(result.result == 0) {
                           ...
                           if($("#resourceId").val()!=''){
                               location.href='${basePath}/resource/site/list';
                           }else{
                               malertInfo("添加成功", 'm-alert-info-success', {});
                               $("#resourceSaveForm").find("input").val("");
                           }
                       } else if(result.result == 500) {
                           if($("#resourceId").val()!=''){
                               malertInfo("更新失败", 'm-alert-info-success', {});
                           }else{
                               malertInfo("添加失败", 'm-alert-info-success', {});
                           }
                       }
                   },
                   error:function ()
