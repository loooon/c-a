...
{
    private final static RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(15000)
     ...
     * @return 返回请求结果
     */
    public static String postReq(final String url, final Map<String, String> paramMap,
            final Map<String, File> fileParamMap) throws Exception
    {
