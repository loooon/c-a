...
public class StrUtil
{
    ...
    /**
     * 切分字符串<br/> a#b#c -> [a,b,c] a##b#c -> [a,"",b,c]
     * 
     * @param str
     *            被切分的字符串
     * @param separator
    ...
    /**
     * 改进JDK subString<br> index从0开始计算，最后一个字符为-1<br> 如果from和to位置一样，返回 ""
     * example: abcdefgh 2 3 -> c abcdefgh 2 -3 -> cde
     * 
     * @param string
     *            String
     * @param fromIndex
