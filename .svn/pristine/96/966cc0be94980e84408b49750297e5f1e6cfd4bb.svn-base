...
public class DbcpManager
{
    ...
    public static final GenericObjectPool init(String poolname, String jdbcDriver, String dbUrl, String dbUser,
            String dbPwd, String dbCharSet, int maxActive) throws Exception
    {
    ...
    public static final GenericObjectPool init(String poolname, String jdbcDriver, String dbUrl, String dbUser,
            String dbPwd, String dbCharSet, int maxActive, String validationQuery) throws Exception
    {
        synchronized (DbcpManager.class)
        {
    ...
    private static GenericObjectPool startDbcp(String poolname, String jdbcDriver, String dbUrl, String dbUser,
            String dbPwd, String dbCharSet, int maxActive, String validationQuery) throws Exception
    {
        // 如果池已经存在，则返回
