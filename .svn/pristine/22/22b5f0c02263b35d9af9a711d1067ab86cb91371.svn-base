...
public class SignReceiptAdapter
{
    ...
    public String sign(String seller, String website, String order, long price, String imageDigest) throws Exception
    {
        ...
        NameValuePair[] httpParams = new NameValuePair[]{new NameValuePair("pname", pname.trim()),
                new NameValuePair("ptime", timestamp), new NameValuePair("seller", encodeSeller.trim()),
                new NameValuePair("website", website.trim()), new NameValuePair("order", order.trim()),
                new NameValuePair("price", String.valueOf(price)),
                new NameValuePair("imageDigest", imageDigest.trim()), new NameValuePair("vkey", vkey),};
